...
(:init
    ...
    (= (traverse-cost wp_init_auv0 waypoint30) 0.06)
    (= (traverse-cost waypoint10 waypoint29) 67.22)
    (= (traverse-cost waypoint29 waypoint10) 67.22)
    (= (traverse-cost waypoint10 waypoint30) 58.97)
    (= (traverse-cost waypoint30 waypoint10) 58.97)
