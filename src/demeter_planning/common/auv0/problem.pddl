...
(:init
    (can-move wp_init_auv0 waypoint11)
    ...
    (= (traverse-cost wp_init_auv0 waypoint11) 0.13)
    ...
    (= (traverse-cost waypoint2 waypoint1) 0.646)
    (= (traverse-cost waypoint2 waypoint11) 3.994)
    (= (traverse-cost waypoint11 waypoint2) 3.994)
