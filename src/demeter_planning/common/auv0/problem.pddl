...
(:objects
    vehicle0 - vehicle
    wp_init_auv0 waypoint12 waypoint3 waypoint2 - waypoint
    data0 - data
    currenttide - tide
    turbine0 - turbine
)
(:init
    ...
    (= (traverse-cost wp_init_auv0 waypoint12) 0.52)
    (= (traverse-cost waypoint12 waypoint3) 13.295)
