...
(:objects
    ...
    data0 data1 data4 - data
    vortex0 vortex1 vortex2 vortex3 vortex4 vortex5 vortex6 vortex7 - vortex
    currenttide - tide
    turbine0 turbine1 turbine2 turbine3 turbine5 turbine4 - turbine
)
(:init
    ...
    (can-move waypoint10 waypoint16)
    ...
    (= (traverse-cost waypoint35 waypoint36) 9.06)
    (= (traverse-cost waypoint36 waypoint35) 9.06)
    (= (traverse-cost waypoint36 waypoint11) 24.38)
    (= (traverse-cost waypoint11 waypoint36) 24.38)
    (= (traverse-cost waypoint7 waypoint19) 29.19)
    (= (traverse-cost waypoint19 waypoint7) 29.19)
    (= (traverse-cost waypoint7 waypoint21) 25.59)
    (= (traverse-cost waypoint21 waypoint7) 25.59)
    (= (traverse-cost waypoint10 waypoint16) 38.24)
    (= (traverse-cost waypoint16 waypoint10) 38.24)
    (= (traverse-cost waypoint10 waypoint11) 61.9)
    (= (traverse-cost waypoint11 waypoint10) 61.9)
    (= (traverse-cost waypoint15 waypoint16) 9.06)
    (= (traverse-cost waypoint16 waypoint15) 9.06)
    (= (traverse-cost waypoint15 waypoint19) 9.06)
    (= (traverse-cost waypoint19 waypoint15) 9.06)
    (= (traverse-cost waypoint20 waypoint21) 9.06)
    (= (traverse-cost waypoint21 waypoint20) 9.06)
