...
(:init
    (can-move wp_init_auv0 waypoint97)
    (can-move waypoint97 waypoint221)
    (can-move waypoint221 waypoint97)
    (can-move waypoint35 waypoint221)
    (can-move waypoint221 waypoint35)
    ...
    (= (traverse-cost wp_init_auv0 waypoint97) 0.00613089)
    (= (traverse-cost waypoint97 waypoint221) 17.3889)
    (= (traverse-cost waypoint221 waypoint97) 17.3889)
    (= (traverse-cost waypoint35 waypoint221) 81.9865)
    (= (traverse-cost waypoint221 waypoint35) 81.9865)
