...
(:init
    ...
    (can-move waypoint8 waypoint18)
    (can-move waypoint18 waypoint8)
    ...
    (= (traverse-cost wp_init_auv0 waypoint15) 24.54)
    (= (traverse-cost waypoint35 waypoint8) 19.03)
    (= (traverse-cost waypoint8 waypoint35) 19.03)
    ...
    (= (traverse-cost waypoint8 waypoint18) 27.45)
    (= (traverse-cost waypoint18 waypoint8) 27.45)
    (= (traverse-cost waypoint15 waypoint19) 9.06)
    (= (traverse-cost waypoint19 waypoint15) 9.06)
    (= (traverse-cost waypoint18 waypoint19) 6.8)
    (= (traverse-cost waypoint19 waypoint18) 6.8)
