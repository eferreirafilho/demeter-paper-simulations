...
(:objects
    ...
    currenttide - tide
    turbine3 turbine2 - turbine
)
(:init
    (can-move wp_init_auv1 waypoint33)
    (can-move waypoint33 waypoint34)
    (can-move waypoint34 waypoint33)
    ...
    (can-move waypoint25 waypoint29)
    (can-move waypoint29 waypoint25)
    ...
    (= (traverse-cost wp_init_auv1 waypoint33) 2.85)
    (= (traverse-cost waypoint33 waypoint34) 6.8)
    (= (traverse-cost waypoint34 waypoint33) 6.8)
    (= (traverse-cost waypoint34 waypoint30) 9.06)
    (= (traverse-cost waypoint30 waypoint34) 9.06)
    ...
    (= (traverse-cost waypoint25 waypoint29) 9.06)
    (= (traverse-cost waypoint29 waypoint25) 9.06)
