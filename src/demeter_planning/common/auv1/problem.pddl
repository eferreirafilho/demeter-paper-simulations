...
(:objects
    ...
    data0 data4 data1 - data
    vortex0 vortex1 vortex2 vortex3 vortex4 vortex5 vortex6 vortex7 - vortex
    currenttide - tide
    turbine0 turbine4 turbine1 - turbine
)
(:init
    (can-move wp_init_auv1 waypoint6)
    (can-move waypoint35 waypoint8)
    (can-move waypoint8 waypoint35)
    (can-move waypoint36 waypoint11)
    (can-move waypoint11 waypoint36)
    (can-move waypoint6 waypoint7)
    (can-move waypoint7 waypoint6)
    (can-move waypoint6 waypoint15)
    (can-move waypoint15 waypoint6)
    (can-move waypoint7 waypoint19)
    (can-move waypoint19 waypoint7)
    (can-move waypoint7 waypoint21)
    (can-move waypoint21 waypoint7)
    (can-move waypoint8 waypoint21)
    (can-move waypoint21 waypoint8)
    (can-move waypoint11 waypoint18)
    (can-move waypoint18 waypoint11)
    (can-move waypoint15 waypoint19)
    (can-move waypoint19 waypoint15)
    ...
    (is-turbine-wp waypoint15 turbine0)
    (is-turbine-wp waypoint16 turbine0)
    (is-turbine-wp waypoint17 turbine0)
    (is-turbine-wp waypoint18 turbine0)
    (is-turbine-wp waypoint19 turbine0)
    (is-turbine-wp waypoint35 turbine4)
    (is-turbine-wp waypoint36 turbine4)
    (is-turbine-wp waypoint37 turbine4)
    (is-turbine-wp waypoint38 turbine4)
    (is-turbine-wp waypoint39 turbine4)
    (is-turbine-wp waypoint20 turbine1)
    (is-turbine-wp waypoint21 turbine1)
    (is-turbine-wp waypoint22 turbine1)
    (is-turbine-wp waypoint23 turbine1)
    (is-turbine-wp waypoint24 turbine1)
    ...
    (= (traverse-cost wp_init_auv1 waypoint6) 37.57)
    (= (traverse-cost waypoint35 waypoint8) 38.07)
    (= (traverse-cost waypoint8 waypoint35) 38.07)
    (= (traverse-cost waypoint36 waypoint11) 48.76)
    (= (traverse-cost waypoint11 waypoint36) 48.76)
    (= (traverse-cost waypoint6 waypoint7) 292.06)
    (= (traverse-cost waypoint7 waypoint6) 292.06)
    (= (traverse-cost waypoint6 waypoint15) 233.12)
    (= (traverse-cost waypoint15 waypoint6) 233.12)
    (= (traverse-cost waypoint7 waypoint19) 58.38)
    (= (traverse-cost waypoint19 waypoint7) 58.38)
    (= (traverse-cost waypoint7 waypoint21) 51.17)
    (= (traverse-cost waypoint21 waypoint7) 51.17)
    (= (traverse-cost waypoint8 waypoint21) 56.87)
    (= (traverse-cost waypoint21 waypoint8) 56.87)
    (= (traverse-cost waypoint11 waypoint18) 35.76)
    (= (traverse-cost waypoint18 waypoint11) 35.76)
    (= (traverse-cost waypoint15 waypoint19) 18.11)
    (= (traverse-cost waypoint19 waypoint15) 18.11)
    (= (traverse-cost waypoint18 waypoint19) 13.61)
    (= (traverse-cost waypoint19 waypoint18) 13.61)
