...
(:objects
    ...
    data1 data4 data5 - data
    vortex0 vortex1 vortex2 vortex3 vortex4 vortex5 vortex6 vortex7 - vortex
    currenttide - tide
    turbine1 turbine4 turbine5 - turbine
)
(:init
    (can-move wp_init_auv1 waypoint6)
    (can-move waypoint10 waypoint26)
    (can-move waypoint26 waypoint10)
    ...
    (is-turbine-wp waypoint21 turbine4)
    ...
    (= (traverse-cost wp_init_auv1 waypoint6) 1.684)
    (= (traverse-cost waypoint10 waypoint26) 4.116)
    (= (traverse-cost waypoint26 waypoint10) 4.116)
    (= (traverse-cost waypoint10 waypoint6) 0.646)
    (= (traverse-cost waypoint6 waypoint10) 0.646)
