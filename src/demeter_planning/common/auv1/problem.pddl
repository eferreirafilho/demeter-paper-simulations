...
(:objects
    ...
    currenttide - tide
    turbine5 turbine4 turbine3 turbine2 - turbine
)
(:init
    ...
    (can-move waypoint27 waypoint26)
    (can-move waypoint27 waypoint21)
    (can-move waypoint21 waypoint27)
    ...
    (is-turbine-wp waypoint26 turbine5)
    ...
    (= (traverse-cost wp_init_auv1 waypoint27) 0.36)
    (= (traverse-cost waypoint16 waypoint11) 3.182)
    (= (traverse-cost waypoint11 waypoint16) 3.182)
    (= (traverse-cost waypoint16 waypoint21) 3.508)
    (= (traverse-cost waypoint21 waypoint16) 3.508)
    (= (traverse-cost waypoint26 waypoint27) 0.646)
    (= (traverse-cost waypoint27 waypoint26) 0.646)
    (= (traverse-cost waypoint27 waypoint21) 3.096)
    (= (traverse-cost waypoint21 waypoint27) 3.096)
