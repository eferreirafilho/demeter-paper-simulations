...
(:objects
    ...
    currenttide - tide
    turbine4 turbine1 - turbine
)
(:init
    (can-move wp_init_auv1 waypoint35)
    ...
    (= (traverse-cost wp_init_auv1 waypoint35) 0.01)
    (= (traverse-cost waypoint8 waypoint35) 19.03)
    (= (traverse-cost waypoint35 waypoint8) 19.03)
    (= (traverse-cost waypoint8 waypoint21) 28.43)
    (= (traverse-cost waypoint21 waypoint8) 28.43)
